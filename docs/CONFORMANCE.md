...
WikiTraveler publishes structured hotel accessibility facts through multiple surfaces: a **Node** operator dashboard, **Field Kit** mobile audit app, **Lens** browser extension, and an embeddable **SDK widget** for partner sites.
...
| Field Kit | On-site auditors | **Partially conformant** |
...
| Field Kit | `apps/field-kit` | 0.1.0 |
...
| Lighthouse accessibility (≥ 90) | Node `/accessibility`, `/login`, `/`; Field Kit `/login`, `/audit/[id]` (CI) |
...
| Criterion | Node | Field Kit | Lens | SDK |
| --- | --- | --- | --- | --- |
...
- Field Kit tab bar implements WAI-ARIA tabs with arrow-key navigation.
...
| L-03 | Field Kit | 200% zoom may clip long audit panels on very narrow viewports | Collapsible Existing Data panel; tabbed layout |
